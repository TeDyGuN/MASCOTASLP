...
@section('content')
    ...
    <div class="register-box">
        <div class="login-logo">
            <a href="{{ url('/home') }}">EMI|<b>VIRTUAL</b></a>
            <img src="{{ asset('img/emi-logo.png') }}" alt="Escuela Militar de Ingenieria" class="img-responsive">
        </div>
        <div class="register-box-body">
            <h4 class="login-box-msg">Si Desea Registrarse comuniquese con su Oficial Encargado de Curso</h4>
