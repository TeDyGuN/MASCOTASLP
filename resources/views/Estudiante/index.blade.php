...
<div class="container">
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-10">
                    ...
                    <div class="col-md-10">
                        <label class="col-md-4  col-ls-4 control-label colorazul">Curso:</label>
                        <label class="col-md-4 col-ls-4 control-label">{{ Auth::user()->curso() }}</label>
                    </div>
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title" style="text-align: center">Materias Registradas</h3>
            </div>
            <div class="panel-body">
                <div class="box">
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($materias as $m)
                                <tr>
                                    ...
                                    <td class="col-md-4">{{ $m->cnombre }}</td>
                                </tr>
                            @endforeach
                        </table>
                    </div><!-- /.box-body -->
